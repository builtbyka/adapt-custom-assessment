# adapt-contrib-custom-assessment 

 **This is the standard Assessment extension but with one addition**

To articles.json add '_order'

"_banks" : {
				"_isEnabled": true,
				"_split": "6,2",
				"_order": [1,1,1,2,1,1,1,2],
				"_randomisation": false
			},

The numbers in the array refer to which quizbank to pull the question from. 
